...
define('_EMAIL_TO', 'inquiry@fastrip.info'); // your email address where reservation details will be received
define('_EMAIL_SUBJECT', 'Holidays Inquiry Form'); // email message subject
...
$fields = array(
	...
	array('name' => 'package-name', 'title' => 'Package Name', 'valid' => array('require')),
	array('name' => 'hotel-type', 'title' => 'Room', 'valid' => array('require')),
	array('name' => 'transportation-fare', 'title' => 'Transportation Fare'),
	array('name' => 'meal-plan', 'title' => 'Meal Plan'),
	...
	array('name' => 'country', 'title' => 'Country Name', 'valid' => array('require')),
	array('name' => 'departure-city', 'title' => 'Departure City', 'valid' => array('require')),
	array('name' => 'email', 'title' => 'Email', 'valid' => array('require')),
	array('name' => 'phone', 'title' => 'Phone', 'valid' => array('require')),
	array('name' => 'details', 'title' => 'Details of a New Customised Holiday Package'),
